...
def initialize_agent(model_name:str = "groq:openai/gpt-oss-120b", temperature:float = 0.7):
...
def get_agents()-> dict:
    """Get the initialized supervisor agent, initializing it if necessary.
    """
...
- dont expose the inner workings and tools to the user. Only present the final recommendations.
...
def create_supervisor_agent(
    ...
    global _agents
    _agents = initialize_agent(model_name, temperature)
